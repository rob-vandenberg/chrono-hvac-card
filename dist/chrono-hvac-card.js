import{LitElement,html,svg,css}from"https://unpkg.com/lit@2.0.0/index.js?module";import{live}from"https://unpkg.com/lit@2.0.0/directives/live.js?module";const CARD_VERSION="0.0.6",CH_ARC_START=210,CH_ARC_SWEEP=300,CH_DEFAULT_MIN_TEMP=7,CH_DEFAULT_MAX_TEMP=35,CH_DEFAULT_STEP=.5,CH_MODE_COLORS={heat:"#ff8100",cool:"#2196f3",heat_cool:"#7c4dff",auto:"#43a047",dry:"#ffc107",fan_only:"#00bcd4",off:"#8a8a8a",idle:"#8a8a8a"},CH_HVAC_MODE_LABELS={off:"Off",heat:"Heat",cool:"Cool",heat_cool:"Heat/Cool",auto:"Auto",dry:"Dry",fan_only:"Fan only"},CH_HVAC_MODE_ICONS={cool:"mdi:snowflake",dry:"mdi:water-percent",fan_only:"mdi:fan",auto:"mdi:thermostat-auto",heat:"mdi:fire",off:"mdi:power",heat_cool:"mdi:sun-snowflake-variant"},CH_HVAC_MODE_ICON_FALLBACK="mdi:thermostat";function chHvacModeIcon(t){return CH_HVAC_MODE_ICONS[t]||"mdi:thermostat"}const CH_HVAC_MODES_ORDER=["auto","heat_cool","heat","cool","dry","fan_only","off"];function chCompareHvacModes(t,e){return CH_HVAC_MODES_ORDER.indexOf(t)-CH_HVAC_MODES_ORDER.indexOf(e)}const DEFAULT_CONFIG={entity:"",name:"",show_current_temperature:!0,show_current_humidity:!0,show_mode_button:!0,show_preset_button:!0,show_fan_button:!0,show_swing_button:!0};function chCapitalize(t){return t?t.charAt(0).toUpperCase()+t.slice(1).replace(/_/g," "):""}function chParseNumber(t){const e=String(t).replace(",",".");if("-"===e||"-0"===e||e.endsWith("."))return null;if(e.includes(".")&&e.endsWith("0"))return null;if(""===e)return;const i=parseFloat(e);return isNaN(i)?null:i}function chPolarToCartesian(t,e,i,o){const r=o*Math.PI/180;return{x:t+i*Math.sin(r),y:e-i*Math.cos(r)}}function chDescribeArc(t,e,i,o,r){if(r<=o)return"";const n=chPolarToCartesian(t,e,i,o),s=chPolarToCartesian(t,e,i,r),a=r-o<=180?0:1;return`M ${n.x} ${n.y} A ${i} ${i} 0 ${a} 1 ${s.x} ${s.y}`}function chAngleForTemp(t,e,i){return 210+300*Math.min(1,Math.max(0,(t-e)/(i-e)))}function chTempForAngle(t,e,i,o){let r=e+(t-210)/300*(i-e);return r=Math.round(r/o)*o,Math.min(i,Math.max(e,r))}function chTextField(t,e,i,o={}){return html`
    ...
    `}_onInput(t){this.value=t.target.value,this.dispatchEvent(new Event("input",{bubbles:!0,composed:!0}))}}customElements.define("ch-textfield",ChTextfield);class ChronoHvacCardEditor extends LitElement{static properties={hass:{type:Object},_config:{type:Object}};setConfig(t){this._config={...DEFAULT_CONFIG,...t}}_valueChanged(t,e){if(!this._config||!this.hass)return;let i;i=void 0!==e.detail?.value?e.detail.value:"HA-SWITCH"===e.target.tagName?e.target.checked:e.target.value,this._config={...this._config,[t]:i},this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0}))}render(){if(!this._config||!this.hass)return html``;const t=this._config,e=t.entity?this.hass.states[t.entity]:void 0,i=e?.attributes||{},o=void 0!==i.current_temperature,r=void 0!==i.current_humidity,n=(i.hvac_modes||[]).length>1,s=(i.preset_modes||[]).length>0,a=(i.fan_modes||[]).length>0,l=(i.swing_modes||[]).length>0;return html`
      <div class="editor">
        ...
        ${n||s||a||l?html`
          ...
          ${s?chToggleField("Show Preset button",t.show_preset_button,t=>this._valueChanged("show_preset_button",t)):""}
          ${a?chToggleField("Show Fan mode button",t.show_fan_button,t=>this._valueChanged("show_fan_button",t)):""}
  ...
  `}customElements.define("chrono-hvac-card-editor",ChronoHvacCardEditor);class ChronoHvacCard extends LitElement{static properties={_dragTarget:{type:String},_dragTemp:{type:Object}};constructor(){super(),this._dragTarget=null,this._dragTemp=null,this._boundPointerMove=this._onPointerMove.bind(this),this._boundPointerUp=this._onPointerUp.bind(this)}set hass(t){this._hass=t}get hass(){return this._hass}setConfig(t){if(!t.entity||"climate"!==t.entity.split(".")[0])throw new Error("Specify an entity from the climate domain");this._config={...DEFAULT_CONFIG,...t}}getCardSize(){return 7}static getConfigElement(){return document.createElement("chrono-hvac-card-editor")}static getStubConfig(){return{...DEFAULT_CONFIG}}get _stateObj(){return this.hass?.states[this._config.entity]}_callService(t,e){this.hass.callService("climate",t,{entity_id:this._config.entity,...e})}_handleMoreInfo(){this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:this._config.entity},bubbles:!0,composed:!0}))}_setHvacMode(t){this._callService("set_hvac_mode",{hvac_mode:t})}_setPresetMode(t){this._callService("set_preset_mode",{preset_mode:t})}_setFanMode(t){this._callService("set_fan_mode",{fan_mode:t})}_setSwingMode(t){this._callService("set_swing_mode",{swing_mode:t})}_step(t,e){const i=this._stateObj;if(!i)return;const o=i.attributes,r=o.target_temp_step||.5,n=o.min_temp??7,s=o.max_temp??35;if(void 0!==o.target_temp_low&&void 0!==o.target_temp_high){const i=o.target_temp_low,a=o.target_temp_high;if("low"===e){const e=Math.min(a,Math.max(n,i+t*r));this._callService("set_temperature",{target_temp_low:e,target_temp_high:a})}else{const e=Math.max(i,Math.min(s,a+t*r));this._callService("set_temperature",{target_temp_low:i,target_temp_high:e})}}else{const e=o.temperature??n,i=Math.min(s,Math.max(n,e+t*r));this._callService("set_temperature",{temperature:i})}}_angleFromPointer(t,e,i){const o=t-(i.left+i.width/2),r=e-(i.top+i.height/2);let n=180*Math.atan2(o,-r)/Math.PI;n<0&&(n+=360);return n<=150&&(n+=360),n<210&&(n=210),n>510&&(n=510),n}_onPointerDown(t){const e=this._stateObj;if(!e||"off"===e.state)return;const i=e.attributes,o=i.min_temp??7,r=i.max_temp??35,n=void 0!==i.target_temp_low&&void 0!==i.target_temp_high,s=t.currentTarget.getBoundingClientRect(),a=this._angleFromPointer(t.clientX,t.clientY,s);if(n){const t=chAngleForTemp(i.target_temp_low,o,r),e=chAngleForTemp(i.target_temp_high,o,r);this._dragTarget=Math.abs(a-t)<=Math.abs(a-e)?"low":"high",this._dragTemp={low:i.target_temp_low,high:i.target_temp_high}}else this._dragTarget="single",this._dragTemp={single:i.temperature??o};this._dialRect=s,window.addEventListener("pointermove",this._boundPointerMove),window.addEventListener("pointerup",this._boundPointerUp),this._onPointerMove(t)}_onPointerMove(t){if(!this._dragTarget)return;const e=this._stateObj.attributes,i=e.min_temp??7,o=e.max_temp??35,r=e.target_temp_step||.5,n=chTempForAngle(this._angleFromPointer(t.clientX,t.clientY,this._dialRect),i,o,r);"single"===this._dragTarget?this._dragTemp={single:n}:"low"===this._dragTarget?this._dragTemp={...this._dragTemp,low:Math.min(n,this._dragTemp.high)}:"high"===this._dragTarget&&(this._dragTemp={...this._dragTemp,high:Math.max(n,this._dragTemp.low)}),this.requestUpdate()}_onPointerUp(){this._dragTarget&&("single"===this._dragTarget?this._callService("set_temperature",{temperature:this._dragTemp.single}):this._callService("set_temperature",{target_temp_low:this._dragTemp.low,target_temp_high:this._dragTemp.high}),this._dragTarget=null,this._dragTemp=null,window.removeEventListener("pointermove",this._boundPointerMove),window.removeEventListener("pointerup",this._boundPointerUp))}_renderDotIcon(){return html`<ha-icon icon="mdi:circle-small"></ha-icon>`}_renderModeRow(t,e){const i=[...t].sort(chCompareHvacModes).map(t=>({value:t,label:CH_HVAC_MODE_LABELS[t]||chCapitalize(t),icon:chHvacModeIcon(t)}));return html`
    ...
    `}_renderAttributeRow(t,e,i,o){const r=e.map(t=>({value:t,label:CH_HVAC_MODE_LABELS[t]||chCapitalize(t)}));return html`
      <ha-control-select-menu
        .label=${t}
        .value=${i}
        .options=${r}
    ...
    `}_renderDial(t){const e=t.attributes,i=t.state,o=(e.hvac_action,e.min_temp??7),r=e.max_temp??35,n=void 0!==e.target_temp_low&&void 0!==e.target_temp_high,s=CH_MODE_COLORS[i]||CH_MODE_COLORS.idle,a=100,l=100,c=88,h=chDescribeArc(a,l,c,210,510);let d="",p=[];if("off"===i);else if(n){const t=this._dragTarget?this._dragTemp.low:e.target_temp_low,i=this._dragTarget?this._dragTemp.high:e.target_temp_high,n=chAngleForTemp(t,o,r),s=chAngleForTemp(i,o,r);d=chDescribeArc(a,l,c,n,s);const h=chPolarToCartesian(a,l,c,n),_=chPolarToCartesian(a,l,c,s);p=[{x:h.x,y:h.y},{x:_.x,y:_.y}]}else{const t=chAngleForTemp(this._dragTarget?this._dragTemp.single:e.temperature??o,o,r);d=chDescribeArc(a,l,c,210,t);const i=chPolarToCartesian(a,l,c,t);p=[{x:i.x,y:i.y}]}return svg`
    ...
    `}_renderCenter(t){const e=t.attributes,i=t.state,o=e.hvac_action,r=void 0!==e.target_temp_low&&void 0!==e.target_temp_high;let n;if(n="idle"===o?"Idle":"off"===i?"Off":CH_HVAC_MODE_LABELS[i]||chCapitalize(i),"off"===i)return html`
        <div class="center">
          <div class="center-label">${n}</div>
        </div>
      `;if(r){const t=this._dragTarget?this._dragTemp.low:e.target_temp_low,i=this._dragTarget?this._dragTemp.high:e.target_temp_high;return html`
        <div class="center">
          <div class="center-label">${n}</div>
      ...
      `}const s=this._dragTarget?this._dragTemp.single:e.temperature,[a,l]=String(s??"").split(".");return html`
      <div class="center">
        <div class="center-label">${n}</div>
        <div class="center-temp-single">
          <span class="whole">${a}</span>
          <span class="frac">
    ...
    `}render(){if(!this.hass||!this._config)return html``;const t=this._stateObj;if(!t)return html`
      ...
      `;const e=t.attributes,i=t.state,o=CH_MODE_COLORS[i]||CH_MODE_COLORS.idle,r=e.hvac_modes||[],n=e.preset_modes||[],s=e.fan_modes||[],a=e.swing_modes||[],l=this._config.name||this.hass.states[this._config.entity]?.attributes?.friendly_name||"",c=[];this._config.show_mode_button&&r.length>1&&c.push(this._renderModeRow(r,i)),this._config.show_preset_button&&n.length&&c.push(this._renderAttributeRow("Preset",n,e.preset_mode,t=>this._setPresetMode(t))),this._config.show_fan_button&&s.length&&c.push(this._renderAttributeRow("Fan mode",s,e.fan_mode,t=>this._setFanMode(t))),this._config.show_swing_button&&a.length&&c.push(this._renderAttributeRow("Swing mode",a,e.swing_mode,t=>this._setSwingMode(t)));const h=`ch-controls-scroll items-${c.length}${c.length>=4?" multiline":""}`,d=this._config.show_current_temperature&&void 0!==e.current_temperature,p=this._config.show_current_humidity&&void 0!==e.current_humidity;return html`
