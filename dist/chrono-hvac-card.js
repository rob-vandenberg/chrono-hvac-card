import{LitElement,html,svg,css}from"https://unpkg.com/lit@2.0.0/index.js?module";import{live}from"https://unpkg.com/lit@2.0.0/directives/live.js?module";const CARD_VERSION="0.0.11",CH_ARC_MAX_ANGLE=270,CH_ARC_ROTATE=135,CH_ARC_RADIUS=145,CH_ARC_VIEWBOX=320,CH_ARC_CENTER=160,CH_SLIDER_MODES={auto:"full",cool:"end",dry:"full",fan_only:"full",heat:"start",heat_cool:"full",off:"full"},CH_DEFAULT_MIN_TEMP=7,CH_DEFAULT_MAX_TEMP=35,CH_DEFAULT_STEP=.5,CH_HVAC_MODE_LABELS={off:"Off",heat:"Heat",cool:"Cool",heat_cool:"Heat/Cool",auto:"Auto",dry:"Dry",fan_only:"Fan only"},CH_HVAC_MODE_ICONS={cool:"mdi:snowflake",dry:"mdi:water-percent",fan_only:"mdi:fan",auto:"mdi:thermostat-auto",heat:"mdi:fire",off:"mdi:power",heat_cool:"mdi:sun-snowflake-variant"},CH_HVAC_MODE_ICON_FALLBACK="mdi:thermostat";function chHvacModeIcon(t){return CH_HVAC_MODE_ICONS[t]||"mdi:thermostat"}const CH_HVAC_MODES_ORDER=["auto","heat_cool","heat","cool","dry","fan_only","off"];function chCompareHvacModes(t,e){return CH_HVAC_MODES_ORDER.indexOf(t)-CH_HVAC_MODES_ORDER.indexOf(e)}const _chPlatformIconsCache={},_chComponentIconsCache={};function chGetIconFromRange(t,e){const o=Object.keys(e).map(Number).filter(t=>!isNaN(t)).sort((t,e)=>t-e);if(!o.length||t<o[0])return;let i=o[0];for(const e of o){if(!(t>=e))break;i=e}return e[String(i)]}function chGetIconFromTranslations(t,e){if(e)return null!=t&&e.state?.[t]?e.state[t]:void 0!==t&&e.range&&!isNaN(Number(t))?chGetIconFromRange(Number(t),e.range)??e.default:e.default}async function chGetPlatformIcons(t,e){if(e in _chPlatformIconsCache)return _chPlatformIconsCache[e];if(!t.config?.components?.includes(e))return;const o=t.callWS({type:"frontend/get_icons",category:"entity",integration:e}).then(t=>t?.resources?.[e]).catch(()=>{});return _chPlatformIconsCache[e]=o,o}async function chGetComponentIcons(t,e){if(e in _chComponentIconsCache)return _chComponentIconsCache[e];if(!t.config?.components?.includes(e))return;const o=t.callWS({type:"frontend/get_icons",category:"entity_component"}).then(t=>t?.resources?.[e]).catch(()=>{});return _chComponentIconsCache[e]=o,o}async function chAttributeIcon(t,e,o,i){const r=e.entity_id.split(".")[0],a=e.attributes.device_class,n=t.entities?.[e.entity_id],s=n?.platform,c=n?.translation_key,l=i??e.attributes[o];let h;if(c&&s){const e=await chGetPlatformIcons(t,s);e&&(h=chGetIconFromTranslations(l,e[r]?.[c]?.state_attributes?.[o]))}if(!h){const e=await chGetComponentIcons(t,r);if(e){h=chGetIconFromTranslations(l,a&&e[a]?.state_attributes?.[o]||e._?.state_attributes?.[o])}}return h}const DEFAULT_CONFIG={entity:"",name:"",show_entity_name_fallback:!0,show_current_temperature:!0,show_current_humidity:!0,show_more_info_button:!0,show_mode_button:!0,show_preset_button:!0,show_fan_button:!0,show_swing_button:!0};function chCapitalize(t){return t?t.charAt(0).toUpperCase()+t.slice(1).replace(/_/g," "):""}function chParseNumber(t){const e=String(t).replace(",",".");if("-"===e||"-0"===e||e.endsWith("."))return null;if(e.includes(".")&&e.endsWith("0"))return null;if(""===e)return;const o=parseFloat(e);return isNaN(o)?null:o}function chSvgArc(t){const{x:e,y:o,r:i,start:r,end:a,rotate:n=0}=t,s=r/180*Math.PI,c=(a/180*Math.PI-s)%(2*Math.PI),l=n/180*Math.PI,h=Math.cos(l),d=Math.sin(l),u=([t,e])=>[h*t-d*e,d*t+h*e],[_,p]=u([i*Math.cos(s),i*Math.sin(s)]).map((t,i)=>t+(0===i?e:o)),[g,m]=u([i*Math.cos(s+c),i*Math.sin(s+c)]).map((t,i)=>t+(0===i?e:o)),f=c>Math.PI?1:0,v=c>0?1:0;return["M",_,p,"A",i,i,l/(2*Math.PI)*360,f,v,g,m].join(" ")}function chClamp(t,e,o){return Math.min(Math.max(t,e),o)}function chValueToPercentage(t,e,o){return(chClamp(t,e,o)-e)/(o-e)}function chStrokeDashArc(t,e,o,i){const r=chValueToPercentage(t,o,i),a=chValueToPercentage(e,o,i),n=290*Math.PI*270/360,s=Math.max((a-r)*n,0);return[`${s} ${n-s}`,`-${r*n-.5}`]}function chStrokeCircleDashArc(t,e,o){return chStrokeDashArc(t,t,e,o)}function chComputeCssVariable(t){return Array.isArray(t)?t.reduceRight((t,e)=>`var(${e}${t?`, ${t}`:""})`,void 0):`var(${t})`}function chSlugify(t){return String(t).toLowerCase().replace(/[^a-z0-9]+/g,"_").replace(/^_+|_+$/g,"")}function chDomainColorProperties(t,e,o,i){const r=chSlugify(o),a=i?"active":"inactive",n=e.attributes.device_class,s=[];return n&&s.push(`--state-${t}-${n}-${r}-color`),s.push(`--state-${t}-${r}-color`,`--state-${t}-${a}-color`,`--state-${a}-color`),s}function chStateColorCss(t,e){const o=void 0!==e?e:t.state;if("unavailable"===o)return"var(--state-unavailable-color)";return chComputeCssVariable(chDomainColorProperties("climate",t,o,"off"!==o))}function chTextField(t,e,o,i={}){return html`
  ...
  `}customElements.define("chrono-hvac-card-editor",ChronoHvacCardEditor);class ChronoHvacCard extends LitElement{static properties={_dragTarget:{type:String},_dragTemp:{type:Object}};constructor(){super(),this._dragTarget=null,this._dragTemp=null,this._boundPointerMove=this._onPointerMove.bind(this),this._boundPointerUp=this._onPointerUp.bind(this),this._attrIconCache={},this._selectedRangeTarget="low"}set hass(t){this._hass=t}get hass(){return this._hass}setConfig(t){if(!t.entity||"climate"!==t.entity.split(".")[0])throw new Error("Specify an entity from the climate domain");this._config={...DEFAULT_CONFIG,...t}}getCardSize(){return 7}static getConfigElement(){return document.createElement("chrono-hvac-card-editor")}static getStubConfig(){return{...DEFAULT_CONFIG}}get _stateObj(){return this.hass?.states[this._config.entity]}_callService(t,e){this.hass.callService("climate",t,{entity_id:this._config.entity,...e})}_handleMoreInfo(){this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:this._config.entity},bubbles:!0,composed:!0}))}_setHvacMode(t){this._callService("set_hvac_mode",{hvac_mode:t})}_setPresetMode(t){this._callService("set_preset_mode",{preset_mode:t})}_setFanMode(t){this._callService("set_fan_mode",{fan_mode:t})}_setSwingMode(t){this._callService("set_swing_mode",{swing_mode:t})}_step(t,e){const o=this._stateObj;if(!o)return;const i=o.attributes,r=i.target_temp_step||.5,a=i.min_temp??7,n=i.max_temp??35;if(void 0!==i.target_temp_low&&void 0!==i.target_temp_high){const o=i.target_temp_low,s=i.target_temp_high;if("low"===e){const e=Math.min(s,Math.max(a,o+t*r));this._callService("set_temperature",{target_temp_low:e,target_temp_high:s})}else{const e=Math.max(o,Math.min(n,s+t*r));this._callService("set_temperature",{target_temp_low:o,target_temp_high:e})}}else{const e=i.temperature??a,o=Math.min(n,Math.max(a,e+t*r));this._callService("set_temperature",{temperature:o})}}_percentageFromPointer(t,e,o){const i=t-(o.left+o.width/2),r=e-(o.top+o.height/2);return chClamp(((180*Math.atan2(r,i)/Math.PI+45-135+360)%360-45)/270,0,1)}_findActiveHandle(t,e,o,i,r){const a=Math.max(e??i,i),n=Math.min(o??r,r);return a>=t?"low":n<=t?"high":Math.abs(t-a)<=Math.abs(t-n)?"low":"high"}_onPointerDown(t){const e=this._stateObj;if(!e||"off"===e.state)return;const o=e.attributes,i=o.min_temp??7,r=o.max_temp??35,a=void 0!==o.target_temp_low&&void 0!==o.target_temp_high,n=t.currentTarget.getBoundingClientRect(),s=i+this._percentageFromPointer(t.clientX,t.clientY,n)*(r-i);a?(this._dragTarget=this._findActiveHandle(s,o.target_temp_low,o.target_temp_high,i,r),this._dragTemp={low:o.target_temp_low,high:o.target_temp_high}):(this._dragTarget="single",this._dragTemp={single:o.temperature??i}),this._dialRect=n,window.addEventListener("pointermove",this._boundPointerMove),window.addEventListener("pointerup",this._boundPointerUp),this._onPointerMove(t)}_onPointerMove(t){if(!this._dragTarget)return;const e=this._stateObj.attributes,o=e.min_temp??7,i=e.max_temp??35,r=e.target_temp_step||.5,a=o+this._percentageFromPointer(t.clientX,t.clientY,this._dialRect)*(i-o),n=chClamp(Math.round(a/r)*r,o,i);"single"===this._dragTarget?this._dragTemp={single:n}:"low"===this._dragTarget?this._dragTemp={...this._dragTemp,low:Math.min(n,this._dragTemp.high)}:"high"===this._dragTarget&&(this._dragTemp={...this._dragTemp,high:Math.max(n,this._dragTemp.low)}),this.requestUpdate()}_onPointerUp(){this._dragTarget&&("single"===this._dragTarget?this._callService("set_temperature",{temperature:this._dragTemp.single}):(this._selectedRangeTarget=this._dragTarget,this._callService("set_temperature",{target_temp_low:this._dragTemp.low,target_temp_high:this._dragTemp.high})),this._dragTarget=null,this._dragTemp=null,window.removeEventListener("pointermove",this._boundPointerMove),window.removeEventListener("pointerup",this._boundPointerUp))}_getAttributeIcon(t,e){const o=`${t}:${e}`;if(o in this._attrIconCache)return this._attrIconCache[o];this._attrIconCache[o]=void 0;const i=this._stateObj;chAttributeIcon(this.hass,i,t,e).then(t=>{this._attrIconCache[o]=t||null,this.requestUpdate()})}_renderModeRow(t,e){const o=[...t].sort(chCompareHvacModes).map(t=>({value:t,label:CH_HVAC_MODE_LABELS[t]||chCapitalize(t),icon:chHvacModeIcon(t)}));return html`
    ...
    `}_renderArcGroup(t,e,o,i,r,a){const n=chSvgArc({x:0,y:0,start:0,end:270,r:145}),s="end"===e?i:o,c=r??s,l=t??s,h=null!=t,d=h?("end"===e?l<=c:"start"===e&&c<=l)?"end"===e?chStrokeDashArc(l,c,o,i):chStrokeDashArc(c,l,o,i):chStrokeCircleDashArc(l,o,i):null,u="full"===e?chStrokeDashArc(o,i,o,i):"end"===e?chStrokeDashArc(l,s,o,i):chStrokeDashArc(s,l,o,i),_=h?chStrokeCircleDashArc(l,o,i):null;return svg`
      <g>
    ...
    `}_renderCenter(t){const e=t.attributes,o=t.state,i=e.hvac_action,r=void 0!==e.target_temp_low&&void 0!==e.target_temp_high,a=i&&"off"!==i?chCapitalize(i):CH_HVAC_MODE_LABELS[o]||chCapitalize(o);if(r){const t=this._dragTarget?this._dragTemp.low:e.target_temp_low,o=this._dragTarget?this._dragTemp.high:e.target_temp_high;return html`
        <div class="ch-info">
          <p class="ch-label">${a}</p>
          <div class="ch-dual">
            <ha-big-number .value=${t} unit="°C" unit-position="top"></ha-big-number>
            <span>–</span>
            <ha-big-number .value=${o} unit="°C" unit-position="top"></ha-big-number>
          </div>
        </div>
      `}const n=this._dragTarget?this._dragTemp.single:e.temperature;return html`
      <div class="ch-info">
        <p class="ch-label">${a}</p>
        ${null!=n?html`<ha-big-number .value=${n} unit="°C" unit-position="top"></ha-big-number>`:""}
      </div>
