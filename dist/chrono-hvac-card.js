import{LitElement,html,svg,css}from"https://unpkg.com/lit@2.0.0/index.js?module";import{live}from"https://unpkg.com/lit@2.0.0/directives/live.js?module";const CARD_VERSION="0.0.5",CH_ARC_START=210,CH_ARC_SWEEP=300,CH_DEFAULT_MIN_TEMP=7,CH_DEFAULT_MAX_TEMP=35,CH_DEFAULT_STEP=.5,CH_MODE_COLORS={heat:"#ff8100",cool:"#2196f3",heat_cool:"#7c4dff",auto:"#43a047",dry:"#ffc107",fan_only:"#00bcd4",off:"#8a8a8a",idle:"#8a8a8a"},CH_HVAC_MODE_LABELS={off:"Off",heat:"Heat",cool:"Cool",heat_cool:"Heat/Cool",auto:"Auto",dry:"Dry",fan_only:"Fan only"},CH_HVAC_MODE_ICONS={cool:"mdi:snowflake",dry:"mdi:water-percent",fan_only:"mdi:fan",auto:"mdi:thermostat-auto",heat:"mdi:fire",off:"mdi:power",heat_cool:"mdi:sun-snowflake-variant"},CH_HVAC_MODE_ICON_FALLBACK="mdi:thermostat";function chHvacModeIcon(t){return CH_HVAC_MODE_ICONS[t]||"mdi:thermostat"}const CH_HVAC_MODES_ORDER=["auto","heat_cool","heat","cool","dry","fan_only","off"];function chCompareHvacModes(t,e){return CH_HVAC_MODES_ORDER.indexOf(t)-CH_HVAC_MODES_ORDER.indexOf(e)}const DEFAULT_CONFIG={entity:"",name:"",show_current_temperature:!0,show_current_humidity:!0,show_mode_row:!0,show_preset_row:!0,show_fan_row:!0,show_swing_row:!0};function chCapitalize(t){return t?t.charAt(0).toUpperCase()+t.slice(1).replace(/_/g," "):""}function chParseNumber(t){const e=String(t).replace(",",".");if("-"===e||"-0"===e||e.endsWith("."))return null;if(e.includes(".")&&e.endsWith("0"))return null;if(""===e)return;const i=parseFloat(e);return isNaN(i)?null:i}function chPolarToCartesian(t,e,i,o){const r=o*Math.PI/180;return{x:t+i*Math.sin(r),y:e-i*Math.cos(r)}}function chDescribeArc(t,e,i,o,r){if(r<=o)return"";const a=chPolarToCartesian(t,e,i,o),s=chPolarToCartesian(t,e,i,r),n=r-o<=180?0:1;return`M ${a.x} ${a.y} A ${i} ${i} 0 ${n} 1 ${s.x} ${s.y}`}function chAngleForTemp(t,e,i){return 210+300*Math.min(1,Math.max(0,(t-e)/(i-e)))}function chTempForAngle(t,e,i,o){let r=e+(t-210)/300*(i-e);return r=Math.round(r/o)*o,Math.min(i,Math.max(e,r))}function chTextField(t,e,i,o={}){return html`
  ...
  `}customElements.define("chrono-hvac-card-editor",ChronoHvacCardEditor);class ChronoHvacCard extends LitElement{static properties={_dragTarget:{type:String},_dragTemp:{type:Object}};constructor(){super(),this._dragTarget=null,this._dragTemp=null,this._boundPointerMove=this._onPointerMove.bind(this),this._boundPointerUp=this._onPointerUp.bind(this)}set hass(t){this._hass=t}get hass(){return this._hass}setConfig(t){if(!t.entity||"climate"!==t.entity.split(".")[0])throw new Error("Specify an entity from the climate domain");this._config={...DEFAULT_CONFIG,...t}}getCardSize(){return 7}static getConfigElement(){return document.createElement("chrono-hvac-card-editor")}static getStubConfig(){return{...DEFAULT_CONFIG}}get _stateObj(){return this.hass?.states[this._config.entity]}_callService(t,e){this.hass.callService("climate",t,{entity_id:this._config.entity,...e})}_handleMoreInfo(){this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:this._config.entity},bubbles:!0,composed:!0}))}_setHvacMode(t){this._callService("set_hvac_mode",{hvac_mode:t})}_setPresetMode(t){this._callService("set_preset_mode",{preset_mode:t})}_setFanMode(t){this._callService("set_fan_mode",{fan_mode:t})}_setSwingMode(t){this._callService("set_swing_mode",{swing_mode:t})}_step(t,e){const i=this._stateObj;if(!i)return;const o=i.attributes,r=o.target_temp_step||.5,a=o.min_temp??7,s=o.max_temp??35;if(void 0!==o.target_temp_low&&void 0!==o.target_temp_high){const i=o.target_temp_low,n=o.target_temp_high;if("low"===e){const e=Math.min(n,Math.max(a,i+t*r));this._callService("set_temperature",{target_temp_low:e,target_temp_high:n})}else{const e=Math.max(i,Math.min(s,n+t*r));this._callService("set_temperature",{target_temp_low:i,target_temp_high:e})}}else{const e=o.temperature??a,i=Math.min(s,Math.max(a,e+t*r));this._callService("set_temperature",{temperature:i})}}_angleFromPointer(t,e,i){const o=t-(i.left+i.width/2),r=e-(i.top+i.height/2);let a=180*Math.atan2(o,-r)/Math.PI;a<0&&(a+=360);return a<=150&&(a+=360),a<210&&(a=210),a>510&&(a=510),a}_onPointerDown(t){const e=this._stateObj;if(!e||"off"===e.state)return;const i=e.attributes,o=i.min_temp??7,r=i.max_temp??35,a=void 0!==i.target_temp_low&&void 0!==i.target_temp_high,s=t.currentTarget.getBoundingClientRect(),n=this._angleFromPointer(t.clientX,t.clientY,s);if(a){const t=chAngleForTemp(i.target_temp_low,o,r),e=chAngleForTemp(i.target_temp_high,o,r);this._dragTarget=Math.abs(n-t)<=Math.abs(n-e)?"low":"high",this._dragTemp={low:i.target_temp_low,high:i.target_temp_high}}else this._dragTarget="single",this._dragTemp={single:i.temperature??o};this._dialRect=s,window.addEventListener("pointermove",this._boundPointerMove),window.addEventListener("pointerup",this._boundPointerUp),this._onPointerMove(t)}_onPointerMove(t){if(!this._dragTarget)return;const e=this._stateObj.attributes,i=e.min_temp??7,o=e.max_temp??35,r=e.target_temp_step||.5,a=chTempForAngle(this._angleFromPointer(t.clientX,t.clientY,this._dialRect),i,o,r);"single"===this._dragTarget?this._dragTemp={single:a}:"low"===this._dragTarget?this._dragTemp={...this._dragTemp,low:Math.min(a,this._dragTemp.high)}:"high"===this._dragTarget&&(this._dragTemp={...this._dragTemp,high:Math.max(a,this._dragTemp.low)}),this.requestUpdate()}_onPointerUp(){this._dragTarget&&("single"===this._dragTarget?this._callService("set_temperature",{temperature:this._dragTemp.single}):this._callService("set_temperature",{target_temp_low:this._dragTemp.low,target_temp_high:this._dragTemp.high}),this._dragTarget=null,this._dragTemp=null,window.removeEventListener("pointermove",this._boundPointerMove),window.removeEventListener("pointerup",this._boundPointerUp))}_renderDotIcon(){return html`<ha-icon icon="mdi:circle-small"></ha-icon>`}_renderModeRow(t,e){const i=[...t].sort(chCompareHvacModes).map(t=>({value:t,label:CH_HVAC_MODE_LABELS[t]||chCapitalize(t),icon:chHvacModeIcon(t)}));return html`
    ...
    `}_renderDial(t){const e=t.attributes,i=t.state,o=(e.hvac_action,e.min_temp??7),r=e.max_temp??35,a=void 0!==e.target_temp_low&&void 0!==e.target_temp_high,s=CH_MODE_COLORS[i]||CH_MODE_COLORS.idle,n=100,l=100,c=88,h=chDescribeArc(n,l,c,210,510);let d="",p=[];if("off"===i);else if(a){const t=this._dragTarget?this._dragTemp.low:e.target_temp_low,i=this._dragTarget?this._dragTemp.high:e.target_temp_high,a=chAngleForTemp(t,o,r),s=chAngleForTemp(i,o,r);d=chDescribeArc(n,l,c,a,s);const h=chPolarToCartesian(n,l,c,a),_=chPolarToCartesian(n,l,c,s);p=[{x:h.x,y:h.y},{x:_.x,y:_.y}]}else{const t=chAngleForTemp(this._dragTarget?this._dragTemp.single:e.temperature??o,o,r);d=chDescribeArc(n,l,c,210,t);const i=chPolarToCartesian(n,l,c,t);p=[{x:i.x,y:i.y}]}return svg`
    ...
    `}_renderCenter(t){const e=t.attributes,i=t.state,o=e.hvac_action,r=void 0!==e.target_temp_low&&void 0!==e.target_temp_high;let a;if(a="idle"===o?"Idle":"off"===i?"Off":CH_HVAC_MODE_LABELS[i]||chCapitalize(i),"off"===i)return html`
        <div class="center">
    ...
    `}render(){if(!this.hass||!this._config)return html``;const t=this._stateObj;if(!t)return html`
      ...
      `;const e=t.attributes,i=t.state,o=CH_MODE_COLORS[i]||CH_MODE_COLORS.idle,r=e.hvac_modes||[],a=e.preset_modes||[],s=e.fan_modes||[],n=e.swing_modes||[],l=this._config.name||this.hass.states[this._config.entity]?.attributes?.friendly_name||"",c=[];this._config.show_mode_row&&r.length>1&&c.push(this._renderModeRow(r,i)),this._config.show_preset_row&&a.length&&c.push(this._renderAttributeRow("Preset",a,e.preset_mode,t=>this._setPresetMode(t))),this._config.show_fan_row&&s.length&&c.push(this._renderAttributeRow("Fan mode",s,e.fan_mode,t=>this._setFanMode(t))),this._config.show_swing_row&&n.length&&c.push(this._renderAttributeRow("Swing mode",n,e.swing_mode,t=>this._setSwingMode(t)));const h=`ch-controls-scroll items-${c.length}${c.length>=4?" multiline":""}`;return html`
